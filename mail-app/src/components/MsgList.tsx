                ...
                <div>
                    {messages.map((msg: any) => (
                        <div key={msg.id}
                            ...
                            <p className={`truncate font-semibold ${styles.message_border}`}>{msg.remetente}</p>
                            ...
                            <p className={`pl-1 w-auto ${styles.message_border}`}><b className="text-xs font-semibold">{formatDate(msg.data)}</b></p>
                        </div>
                    ))}
